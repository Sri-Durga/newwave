					...
					<?php 
                        ...
                        if (mysqli_num_rows($result) > 0) 
				        {
				            while($row = mysqli_fetch_assoc($result)) {
                                $image = substr($row['product_image'],0,strlen($row['product_image'])-7);
				                echo '
                                <div class="col-md-5 col-md-push-2">
                                <div id="product-main-img">
                                    <div class="product-preview">
                                        <img src="product_images/'.$image.'(1).PNG" alt="">
                                    </div>

                                    <div class="product-preview">
                                        <img src="product_images/'.$image.'(2).PNG" alt="">
                                    </div>

                                    <div class="product-preview">
                                        <img src="product_images/'.$image.'(3).PNG" alt="">
                                    </div>

                                    <div class="product-preview">
                                        <img src="product_images/'.$image.'(4).PNG" alt="">
                                    </div>
                                    
                                    <div class="product-preview">
                                        <img src="product_images/'.$image.'(5).PNG" alt="">
                                    </div>
